...
async function confirmDelivery(){
  ...
  showLoader("Registrando entrega aceita...");
  const res=await api("createWhatsappAcceptedDelivery",deliveryData);
  hideLoader();
