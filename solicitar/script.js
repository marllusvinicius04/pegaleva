...
$("removeQuickLogin").onclick=()=>{
  ...
  try{
    ...
    requestAnimationFrame(()=>{step=5;render()});
  }catch(x){
    toast(x.message);
    step=3;
    render();
